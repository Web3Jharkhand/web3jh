...
const AboutUs = () => {
  return (
    <div>
        <div className="about-page" style={{marginTop:"24rem"}}>
            ...
            <div className="about-content-down">
                ...
                <div className="all-aims">
                    ...
                    <div className="each-aim">
                        <img src="vision 2.png" alt="" className='each-aim-img-2' />
                    ...
                    <div className="each-aim">
                        <img src="goal 1.png" alt="" className='each-aim-img-3' />
                        <p className='each-aim-title' style={{marginLeft:"1rem"}}>GOAL</p>
                        <p className='each-aim-desc'>Create a supportive community that learn, builds and nurture Web3 culture across Jharkhand and its nearby regions.</p>
                    </div>
                </div>
            </div>
            </div>
