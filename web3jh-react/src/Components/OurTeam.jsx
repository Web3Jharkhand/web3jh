  ...
  return (
    <div>
        <div className="OurTeam-page">
            <p className="head-our-team">Our Team</p>
            <div className="all-members">
                ...
                <div className="each-members">
                    <div className='each-mem-div-img'>
                    <img src="Untitled - Shahnawaz Khan.jpeg" alt="" className='each-mem-img' height="242.195px" width="242.195px" />
                    </div>
                    <div className="each-mem-content">
                ...
                <div className="each-members">
                    <div className='each-mem-div-img'>
                    <img src="PXL_20230530_193048258.PORTRAIT - Ankit Kumar.jpg" alt="" className='each-mem-img' height="242.195px" width="242.195px" />
                    </div>
                    <div className="each-mem-content">
                ...
                <div className="each-members">
                    <div className='each-mem-div-img'>
                    <img src="IMG_20230718_183103 - Kumar Rajeev.jpg" alt="" className='each-mem-img' height="242.195px" width="242.195px" />
                    </div>
                    <div className="each-mem-content">
                ...
                <div className="each-members">
                    <div className='each-mem-div-img'>
                    <img src="DSC_0354-01 - Riddhi Bhagat.jpeg" alt="" className='each-mem-img' height="242.195px" width="242.195px" />
                    </div>
                    <div className="each-mem-content">
                ...
                <div className="each-members">
                    <div className='each-mem-div-img'>
                    <img src="IMG_20220919_055929 - Deevesh Mishra.jpg" alt="" className='each-mem-img' height="242.195px" width="242.195px" />
                    </div>
                    <div className="each-mem-content">
                        <p className='mem-name'>Deevesh Mishra</p>
                        <p className="mem-designation">Chapter Co-Lead</p>
                        <p className="mem-designation" style={{paddingTop:"0.4rem"}}>BIT MESRA</p>
                        <div className="each-mem-social">
                            <a href="https://www.linkedin.com/in/deevesh-kumar-1565aa1a7"><img src="image 4.png" alt="" /></a>
                            <a href="https://twitter.com/D_mishra_32"><img src="twitter 1.png" alt="" /></a>
                ...
                <div className="each-members">
                    <div className='each-mem-div-img'>
                    <img src="1648678652058 - ANUJ GUPTA.jpg" alt="" className='each-mem-img' height="242.195px" width="242.195px" />
                    </div>
                    <div className="each-mem-content">
                        <p className='mem-name'>Anuj Gupta </p>
                        <p className="mem-designation">Chapter Co-Lead</p>
                        <p className="mem-designation" style={{paddingTop:"0.4rem"}}>IIIT Ranchi</p>
                        <div className="each-mem-social">
                            <a href="https://www.linkedin.com/in/anuj-gupta-6115261b7/"><img src="image 4.png" alt="" /></a>
                            <a href="https://twitter.com/AnujGup00356629"><img src="twitter 1.png" alt="" /></a>
                ...
                <div className="each-members">
                    <div className='each-mem-div-img'>
                    <img src="Snapchat-1045706067 - Nishant Rai.jpg" alt="" className='each-mem-img' height="242.195px" width="242.195px" />
                    </div>
                    <div className="each-mem-content">
                        <p className='mem-name'>Nishant Kumar Rai</p>
                        <p className="mem-designation">Chapter Co-Lead</p>
                        <p className="mem-designation" style={{paddingTop:"0.4rem"}}>NIAMT Ranchi</p>
                        <div className="each-mem-social">
                            <a href="https://www.linkedin.com/in/nishant-rai-12820b1a7"><img src="image 4.png" alt="" /></a>
                            <a href="https://twitter.com/Nishantrai829"><img src="twitter 1.png" alt="" /></a>
                ...
                <div className="each-members">
                    <div className='each-mem-div-img'>
                    <img src="Untitled design (12) - Pradeep Mondal.png" alt="" className='each-mem-img' height="242.195px" width="242.195px" />
                    </div>
                    <div className="each-mem-content">
                        <p className='mem-name'>Pradeep Mondal</p>
                        <p className="mem-designation">Lead Developer</p>
                        
                        <div className="each-mem-social">
                            <a href="https://www.linkedin.com/in/impradeepmondal/"><img src="image 4.png" alt="" /></a>
                            <a href="https://twitter.com/ppmtwts"><img src="twitter 1.png" alt="" /></a>
                ...
                <div className="each-members">
                    <div className='each-mem-div-img'>
                    <img src="IMG_20230224_230404 - Nishant Kumar Singh.jpg" alt="" className='each-mem-img' height="242.195px" width="242.195px" />
                    </div>
                    <div className="each-mem-content">
                        <p className='mem-name'>Nishant Kumar Singh</p>
                        <p className="mem-designation">Lead Designer</p>
                        
                        <div className="each-mem-social">
                            <a href="https://www.linkedin.com/in/nishant-kumar-singh-4b9523271/"><img src="image 4.png" alt="" /></a>
                            <a href="https://www.linkedin.com/in/nishant-kumar-singh-4b9523271/"><img src="twitter 1.png" alt="" /></a>
